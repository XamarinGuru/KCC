...
namespace PortableLibrary
{
	...
	{
        public const string FCM_SERVER_KEY = "AAAAsT5jiHY:APA91bHlC2tyd-uJ7_Nrmo62BnrNlL6kdm11j5PPAV9B6cfQz_W7g9qqh-OxNXz6JQK8820IKWoKmyp8lb5Br8IZKgJyecDmkDjGgxJHMaYDn3ZzU7CEdRcPsmpxYghLwrkDhqVi5NJu";
        public const string URL_FBDB_BASE = "https://krayot-cycling-cloub.firebaseio.com/";
		...
		public const string SPEC_GROUP_TYPE = "kcc" ;
		public const string DEVICE_CALENDAR_TITLE = "Krayot Cycling Cloub Calendar";
		public const string GROUP_COLOR = "4BA590";
		public const string MSG_SIGNUP_FAIL = "You are not registered to Krayot Cycling Cloub services.";
		#endregion
